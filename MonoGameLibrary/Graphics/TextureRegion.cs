...
public class TextureRegion
{
    ...
    /// <summary>
    /// Gets or sets the rectangular region within the source texture.
    /// </summary>
    ...
    /// <param name="position">The xy-coordinate location to draw this texture region on the screen.</param>
    /// <param name="color">The color mask to apply when drawing this texture region on screen.</param>
    /// <param name="rotation">The amount to rotate this texture region, in radians.</param>
    /// <param name="origin">The point around which to rotate this texture region.</param>
    /// <param name="scale">The scale factor to apply when drawing this texture region.</param>
    /// <param name="effects">The effects to apply when drawing this texture region.</param>
    /// <param name="layerDepth">The depth of the layer on which to draw this texture region.</param>
